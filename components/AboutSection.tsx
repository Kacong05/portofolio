      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1 relative flex justify-center items-center">
          <div className="relative w-[250px] h-[250px]">
            ...
            {/* Decorative Circles - Separate orbits on right and left */}
            <div className="absolute inset-0">
              {/* Green Circle - Orbits on RIGHT side */}
              ...
              {/* Purple Circle - Orbits on LEFT side */}
        ...
        <div className="flex-[1.5]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 my-5">
            <div className="info-card-blue bg-gradient-to-r from-blue-600/20 to-slate-700/20 border rounded-lg p-2.5 flex items-center gap-3 hover:-translate-y-1 hover:shadow-lg transition-all" style={{ borderColor: '#334155' }}>
              <i className="fas fa-map-marker-alt text-blue-500 text-xl w-5 text-center"></i>
              <span className="text-xs">Jember, Indonesia</span>
            </div>

            <div className="info-card-green bg-gradient-to-r from-emerald-600/20 to-slate-700/20 border rounded-lg p-2.5 flex items-center gap-3 hover:-translate-y-1 hover:shadow-lg transition-all" style={{ borderColor: '#334155' }}>
              <i className="fas fa-envelope text-emerald-600 text-xl w-5 text-center"></i>
              <span className="text-xs">adityahardiansyah5@gmail.com</span>
            </div>

            <div className="info-card-purple bg-gradient-to-r from-fuchsia-600/20 to-slate-700/20 border rounded-lg p-2.5 flex items-center gap-3 hover:-translate-y-1 hover:shadow-lg transition-all" style={{ borderColor: '#334155' }}>
              <i className="fas fa-phone text-fuchsia-600 text-xl w-5 text-center"></i>
              <span className="text-xs">+62 857 0877 9638</span>
            </div>

            <div className="info-card-brown bg-gradient-to-r from-amber-700/20 to-slate-700/20 border rounded-lg p-2.5 flex items-center gap-3 hover:-translate-y-1 hover:shadow-lg transition-all" style={{ borderColor: '#334155' }}>
              <i className="fas fa-graduation-cap text-amber-700 text-xl w-5 text-center"></i>
